...
function Footer() {
  return (
    <footer className='grid gap-8 md:justify-between md:grid-cols-5 md:gap-0 mt-32'>
        <div>
            <img src={logo} alt="" />
            <p className='text-base text-gray-600'>隐私协议</p>
        </div>

        {[1,2,3].map(v=>(
            <nav key={v} className='grid gap-2 text-gray-500'>
                <p className='text-black font-bold'>产品介绍</p>
                <a href="">产品介绍1</a>
                <a href="">产品介绍2</a>
                <a href="">产品介绍3</a>
                <a href="">产品介绍4</a>
        ...
        <nav className='grid gap-2 content-start'>
            <p className='text-black font-bold'>注册</p>
            <p className='text-gray-500'>等91239123好2hhjsj</p>
            <input type="text" placeholder='您的邮箱' className='py-3 pl-5 border border-zinc-300 rounded' />
        </nav>

        {/* 全宽info */}
        <div className='col-span-full border-t-2 mt-16 py-8 flex items-center  flex-col justify-between md:flex-row'>
            <p className='mb-6 md:mb-0'>由 <a href="#" className='text-blue-600 font-medium '>Cruip</a> 提供设计。All rights reserved</p>
