...
function Solution() {
  return (
    <div className='grid justify-items-center'>
        <SectionHeader title={'解决方案'} subTitle={'解决方案解决方案解决方案解决方案'} />

        <div className='grid gap-5 lg:grid-cols-2 mt-20'>
            <div className=''>
                <h3 className='text-2xl font-bold'>强有力的工具</h3>
                <p className='text-gray-500 mt-3 mb-10 '>强有力的工具强有力的工具强有力的工具强有力的工具</p>

                <ul className='grid gap-6'>
                    {
                        [1,2,3].map(v => (
                            <li 
                            className={` p-5 rounded border border-zinc-100 ${v===1 && 'bg-zinc-100'}`} 
                            key={v}>
                                <p className='text-xl font-bold'>构建简单的生态系统</p>

                                <div className='flex justify-between mt-2 relative'>
                                    <p className='text-gray-500 leading-7 text-lg'>构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统</p>
                                    <svg
                                    width="38"
                                    height="38"
                                    viewBox="0 0 38 38"
